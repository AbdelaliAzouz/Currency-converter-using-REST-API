package com.example.miniprojet1convertisseurdedevises;
...
public class MainActivity extends AppCompatActivity {
    ...
    String[] country = {"AED", "AFN", "ALL", "AMD", "ANG", "AOA", "ARS", "AUD", "AWG", "AZN", "BAM", "BBD", "BDT", "BGN", "BHD", "BIF",
            "BMD", "BND", "BOB", "BRL", "BSD", "BTC", "BTN", "BWP", "BYN", "BYR", "BZD", "CAD", "CDF", "CHF", "CLF", "CLP", "CNY", "COP",
            ...
            "SAR", "SBD", "SCR", "SDG", "SEK", "SGD", "SHP", "SLL", "SOS", "SRD", "STD", "SVC", "SYP", "SZL", "THB", "TJS", "TMT", "TND",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        convertFromDropDownTextView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //Create a new Dialog and set its content view to the layout from_spinner
        ...
        convertButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    //La fonction qui fait la conversion
    ...
    public String getConversionRate(String convertFrom, String convertTo, Double amountToConvert){
        ...
        //String url = "https://api.exchangerate.host/convert?from=USD&to=EUR";
